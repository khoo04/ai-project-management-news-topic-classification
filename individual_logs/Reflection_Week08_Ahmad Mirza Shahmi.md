...
I would, instead of insulating the development process from external noise, force a collision with end-users immediately, since building in a vacuum simply guarantees we solve the wrong problem with immaculate precision.
